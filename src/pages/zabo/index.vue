          ...
          <div>
            <el-row>
              <el-col :span="4" style="margin-top: 25px">
                <div @click="isShowSub(0)" style="margin-left: 20px">
                  <dv-border-box-13
                    style="
                      cursor: pointer;
                      color: #1541c2;
                    ...
                    :color="['#6987d6', '#5089da']"
                    class="middlesize"
                    ><span ref="zhenshi">真实场景展示</span></dv-border-box-13
                  >
                </div>
              </el-col>
              <el-col :span="4" style="margin-top: 25px">
                <div @click="isShowSub(1)">
                  <dv-border-box-13
                    style="
                      cursor: pointer;
                      color: #1541c2;
                    ...
                    :color="['#6987d6', '#5089da']"
                    class="middlesize"
                    ><span ref="shuju">数据预处理</span></dv-border-box-13
                  >
                </div>
              </el-col>
              <el-col :span="4" style="margin-top: 25px">
                <div @click="isShowSub(2)">
                  <dv-border-box-13
                    style="
                      cursor: pointer;
                      color: #1541c2;
                    ...
                    :color="['#6987d6', '#5089da']"
                    class="middlesize"
                    ><span ref="zabo">杂波建模</span></dv-border-box-13
                  >
                </div>
              </el-col>
            </el-row>
            ...
            <div v-show="showsub[0]" style="margin-top: 20px">
              <el-row>
                <el-button
                  @click="(img.truth = true), (img.radar = true)"
              ...
              <el-row class="martop">
                <el-col :span="6" v-if="img.yuanshi">
                  ...
                  >
                    ...
                    <div
                      ...
                      v-loading="loading.yuanshi.isloading"
                      :element-loading-text="loading.yuanshi.num"
                    >
                      <img
                        v-bind:src="img_src_yuanshi"
                ...
                <el-col :span="6" :offset="2" v-if="img.maichong">
                  ...
                  >
                    ...
                    <div
                      style="text-align: center"
                      v-loading="loading.maichong.isloading"
                      :element-loading-text="loading.maichong.num"
                    >
                      <img
                        v-bind:src="img_src_maichong"
                        style="height: 370px; width: 500px"
                      />
                    </div>
                  </dv-border-box-12> </el-col
                ><el-col :span="6" :offset="2" v-if="img.target">
                  <dv-border-box-12
                    :reverse="true"
                    :color="['#6987d6', '#5089da']"
                    style="height: 410px; width: 520px"
                  >
                    ...
                    <div
                      style="text-align: center"
                      v-loading="loading.target.isloading"
                      :element-loading-text="loading.target.num"
                    >
                      <img
                        v-bind:src="img_src_target"
                        style="height: 370px; width: 500px"
                      />
                    </div>
                  </dv-border-box-12>
            ...
            >
              ...
              <el-row class="martop" v-if="img.zabo">
                <el-col :span="6"
                  ><dv-border-box-12
                    :reverse="true"
                    :color="['#6987d6', '#5089da']"
                  ...
                  >
                    ...
                    <div
                      style="text-align: center"
                      v-loading="loading.zabo.isloading"
                      :element-loading-text="loading.zabo.num"
                    >
                      <img
                        v-bind:src="img_src_zabo"
                        style="height: 370px; width: 500px"
                      />
                    </div>
                  </dv-border-box-12>
...
export default {
  ...
  data() {
    return {
      ...
      loading: {
        yuanshi: { isloading: false, num: 0 },
        maichong: { isloading: false, num: 0 },
        target: { isloading: false, num: 0 },
        zabo: { isloading: false, num: 0 },
      },
      activeName: "first",
  ...
  methods: {
    isShowSub(index) {
      ...
      switch (index) {
        case 0: {
          this.$refs.zhenshi.style = "color:black";
          this.$refs.shuju.style = "color:#233d72";
          this.$refs.zabo.style = "color:#233d72";
          break;
        }
        case 1: {
          this.$refs.zhenshi.style = "color:#233d72";
          this.$refs.shuju.style = "color:black";
          this.$refs.zabo.style = "color:#233d72";
          break;
        }
        case 2: {
          this.$refs.zhenshi.style = "color:#233d72";
          this.$refs.shuju.style = "color:#233d72";
          this.$refs.zabo.style = "color:black";
        }
      }
    },
    async loadData() {
      ...
      if (result.code == 200) {
        ...
        this.img_src_yuanshi =
          "http://127.0.0.1:8080/preview/origClutterData.jpg";
        this.$message({
          type: "success",
          message: "加载成功!",
        });
    ...
    async addTarget() {
      ...
      if (result.code == 200) {
        ...
        this.img_src_target =
          "http://127.0.0.1:8080/preview/afterAddTarget.jpg";
        this.$message({
          type: "success",
          message: "运行成功!",
        });
    ...
    async modeling() {
      ...
      if (result.code == 200) {
        ...
        this.img_src_doppler =
          "http://127.0.0.1:8080/preview/clusterResult.jpg";
        this.$message({
          type: "success",
          message: "运行成功!",
        });
