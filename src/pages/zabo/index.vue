  ...
  <div>
    <Transition appear enter-active-class="animate__animated animate__fadeInLeft"
      ...
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>杂波模型</el-breadcrumb-item>
      </el-breadcrumb>
    </Transition>
      ...
      <Transition appear enter-active-class="animate__animated animate__fadeInLeft"
        ...
        <el-tabs v-model="activeName" type="card">
          <el-tab-pane label="真实场景展示" name="first">
            ...
            <el-row>
              <el-col :span="6">
                <p style="font-size:28px; text-align:center">实际场景图</p>
                <div style="text-align:center;">
                  <el-image v-bind:src="img_src_truth" fit="scale-down" />
                </div>
              </el-col>
              <el-col :span="6" :offset="2">
                <p style="font-size:28px; text-align:center">雷达部分回波图</p>
                <div style="text-align:center;">
          ...
          <el-tab-pane label="数据预处理" name="second">
            <el-row>
              <el-col :span="4">
                <h3 style="margin-top: 10px" class="size">
                  <span style="color: #409eff">|</span>&nbsp;原始数据
                </h3>
              </el-col>
              <el-col :span="2">
                <h3 class="size" style="margin-top: 10px;">帧数</h3>
              </el-col>
            ...
            <el-row style="margin-top: 10px">
              <el-col :span="4">
                <h3 class="size" style="margin-top: 10px;">
                  <span style="color: #409eff">|</span>&nbsp;加目标（SNR/dB）
                </h3>
              </el-col>
              <el-col :span="2">
                <h3 class="size" style="margin-top: 10px;">SNR/dB</h3>
              </el-col>
            ...
            <el-row style="margin-top: 10px;">
              <el-col :span="6">
                <p style="font-size:28px; text-align:center">原始数据图</p>
              ...
              <el-col :span="6" :offset="2">
                <p style="font-size:28px; text-align:center">脉冲压缩图</p>
                ...
                <p style="font-size:28px; text-align:center">添加目标图</p>
          ...
          <el-tab-pane label="杂波建模" name="third">
            <el-row style="margin-top: 10px">
              ...
              <el-col :span="2">
                <h3 class="size" style="margin-top: 10px;">建模类别数</h3>
              </el-col>
              ...
              <el-col :span="6">
                <p style="font-size:28px; text-align:center">杂波建模图</p>
